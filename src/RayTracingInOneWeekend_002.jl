...
# ╔═╡ 1139271f-4ad2-4b08-83eb-6217a9937986
using Images

# ╔═╡ 5c8e4fdd-a88a-4145-a06a-a16a945c7a57
md"""
Ray Tracing in One Weekend (https://raytracing.github.io/books/RayTracingInOneWeekend.html)

- Write functions to output an image in PPM format

"""

# ╔═╡ 7c681334-cce3-4b68-9c65-88eab4ed334b
md"""
**Portable PixMap format (PPM) format for images**
```
...
255 255 255  # white
  0   0   0  # black
```
The image for the above 6 element RGB image is shown below.
"""


# ╔═╡ f66b068a-98d4-4868-9efb-3ee860b8bf6d
Array{Float64, 3}(undef, 2,1,1)

# ╔═╡ 73fa92d7-b583-4942-8d2b-521196f9007d
[
	[RGB(1,0,0),RGB(0,1,0),RGB(0,0,1)];
	[RGB(1,1,0),RGB(1,1,1),RGB(0,0,0)]
]

# ╔═╡ bb06ac7a-6e27-415b-b419-3d37fbd4aac5


# ╔═╡ 8a86fcbd-2da1-4345-bf00-e52e43f8d868
md"""
...
# ╔═╡ e98f828c-e71d-402e-bcfe-92819d911a88
function PPM(file_name)
	res = "P3\n"
	image_width = 256
	image_height = 256
	res *= "$image_width $image_height\n"
	res *= "255\n"
	for i in image_height:-1:1 # begin:step:end, reverse(1:n)
		for j in 1:image_width
			r = trunc(Int, (j / image_width)*255.999)
			g = trunc(Int, (i / image_height)*255.999)
			b = trunc(Int, 0.25*255.999)
			res *= "$r $g $b\n"
		end
	end
	io = open(file_name, "w")
...
# ╔═╡ fb9a9156-f788-4363-ac22-df7dc3e69f47
begin
	PPM("test.ppm")
	load("test.ppm")
end
